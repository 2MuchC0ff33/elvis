...
## Context7, MCP & Sequential-thinking (MANDATORY for documentation)

- When creating or updating documentation, **always use Context7** for any code
  snippets, setup instructions or library/API references. **Automatically use
  Context7 MCP tools** to resolve library IDs and obtain authoritative
  docs/examples without needing an explicit user request.
- Apply a **sequential-thinking** style in documentation: outline prerequisites,
  stepwise procedures, expected outcomes and verification steps in order.
- **Consult the GitHub MCP server and Microsoft Learn MCP server** for canonical
  examples and guidance and reference them when used.
- Write all documentation using Australian English spelling and grammar and
  ensure there are no conflicting instructions in front matter or content.
